...
@register_adv_est(AdvantageEstimator.PASSK_TRAINING)  # or simply: @register_adv_est("passk_training")
def compute_advantage(
    ...
    **kwargs,
    ...
    """
    Compute advantage for Pass@k training.
